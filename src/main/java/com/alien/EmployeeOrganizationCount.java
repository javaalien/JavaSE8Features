...
// Count Male and Female Employees in Organization
...
public class EmployeeOrganizationCount {
	...
	public static void main(String[] args) {
		...
		long femalesInInfosys = employees.stream()
				.filter(e -> "Female".equals(e.getGender()) && "Infosys".equals(e.getOrganization())).count();
		long malesInTCS = employees.stream()
				.filter(e -> "Male".equals(e.getGender()) && "TCS".equals(e.getOrganization())).count();
		long femalesInTCS = employees.stream()
				.filter(e -> "Female".equals(e.getGender()) && "TCS".equals(e.getOrganization())).count();
